...
def compute_confusion(
    ...
    Args:
        ...
        data (Dataset): (Testing) datasets to use for evaluation.
        le (Encoder): Mapping from human readable to machine readable.
        batch_size (int, optional): Defaults to 512.
        mask (pd.DataFrame.mask, optional): Mask to apply to the datasets before computing
...
def _confusion_matrix(
    ...
    for true_label in range(confusion_matrix.shape[0]):
        ...
        # with datasets for all of the classes that could be predicted
