...
def plot_IQ(
    ...
    """Plot IQ datasets in the time dimension.
    ...
    Returns:
        [Figure]: Figure that the datasets was plotted onto (e.g. for saving plot)
    """
    if len(iq.shape) != 2:
...
def plot_convergence(
    ...
    Raises:
        ...
        ValueError: If train_loss and val_loss don't have any datasets (length is 0)
    ...
    if len(train_loss) == 0:
        raise ValueError("There must be datasets to plot (passed lengths were 0).")
...
def plot_acc_vs_snr(
    ...
    Args:
        ...
        annotate (bool, optional): If True then the peak accuracy will be annotated with
                                   ...
                                   plotted datasets.  Defaults to True.
