...
class StandardTrainingStrategy(TrainingStrategy):
    ...
    def __call__(
        ...
        """Train the model on the provided training datasets.

        Args:
            model (Model): Model to fit to the training datasets.
        ...
        # Fit the datasets for the maximum number of epochs, bailing out early if
